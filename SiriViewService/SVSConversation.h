...
#import "AFUIConversation.h"

@class NSString, NSUUID, SVSTreeNode;
...
@property(retain, nonatomic, getter=_rootNode, setter=_setRootNode:) SVSTreeNode *rootNode; // @synthesize rootNode=_rootNode;
@property(nonatomic) __weak id <SVSConversationDelegate> delegate; // @synthesize delegate=_delegate;
