...
@class AFUIDialogPhase, AceObject, NSArray, NSIndexPath, NSString, NSURL, NSUUID, SAUIListItem;
...
- (AFUIDialogPhase *)siriPresentation:(id <SiriUIPresentation>)arg1 dialogPhaseForItemAtIndexPath:(NSIndexPath *)arg2;
...
- (void)siriPresentation:(id <SiriUIPresentation>)arg1 insertAceViews:(NSArray *)arg2 withDialogPhase:(AFUIDialogPhase *)arg3 asItemsAtIndexPaths:(NSArray *)arg4;
...
- (id <AFUIConversation>)siriPresentation:(id <SiriUIPresentation>)arg1 conversationWithIdentifier:(NSUUID *)arg2;
