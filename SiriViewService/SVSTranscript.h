...
@class AFUIQueue, NSMutableArray, NSString;
...
@property(readonly, nonatomic, getter=_loadingTranscriptItemGroupQueue) AFUIQueue *loadingTranscriptItemGroupQueue; // @synthesize loadingTranscriptItemGroupQueue=_loadingTranscriptItemGroupQueue;
