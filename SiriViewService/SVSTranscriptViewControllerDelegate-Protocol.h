...
@class AceObject<SAAceCommand>, NSArray, NSBundle, NSString, NSURL, NSUUID, SASSpeechRecognized, SVSTranscriptViewController, UIView, UIViewController;

@protocol SVSTranscriptViewControllerDelegate <NSObject>
- (void)transcriptViewController:(SVSTranscriptViewController *)arg1 didShowSnippetWithIdentifier:(NSUUID *)arg2 forInterval:(double)arg3;
...
- (void)transcriptViewController:(SVSTranscriptViewController *)arg1 setStatusBarHidden:(_Bool)arg2;
...
- (void)transcriptViewController:(SVSTranscriptViewController *)arg1 didCorrectRecognition:(NSString *)arg2 correctionIdentifier:(id)arg3 forItemAtIndex:(long long)arg4;
