...
@class AFUIDialogPhase, AceObject, NSString, NSUUID, SVSDataStore;
...
@property(readonly, nonatomic) SVSDataStore *associatedDataStore; // @synthesize associatedDataStore=_associatedDataStore;
...
@property(retain, nonatomic) AFUIDialogPhase *dialogPhase; // @synthesize dialogPhase=_dialogPhase;
@property(retain, nonatomic) AceObject *aceObject; // @synthesize aceObject=_aceObject;
@property(nonatomic) long long type; // @synthesize type=_type;
@property(readonly, nonatomic) NSUUID *revisionIdentifier; // @synthesize revisionIdentifier=_revisionIdentifier;
