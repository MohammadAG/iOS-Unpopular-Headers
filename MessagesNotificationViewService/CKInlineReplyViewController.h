...
#import "NCInteractiveNotificationViewController.h"
...
@class CKAudioBalloonView, CKAudioController, CKAudioMediaObject, CKInlineReplyRaiseController, CKMessageEntryView, CKScheduledUpdater, NSString, UIView;
